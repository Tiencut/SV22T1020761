...
namespace SV22T1020218.Admin.Controllers
{
    ...
    {
        private const string PRODUCT_SEARCH = "ProductSearchInput"; //Key lưu dữ liệu tìm kiếm của mặt hàng vào Session
        ...
        public async Task<IActionResult> SaveData(Product data, IFormFile? uploadPhoto)
        {
            try
            {
                // ĐÃ FIX LỖI COPY-PASTE (Khách hàng -> Sản phẩm)
                ...
                {
                    // Trả lại danh sách Ảnh và Thuộc tính để View không bị lỗi Null
