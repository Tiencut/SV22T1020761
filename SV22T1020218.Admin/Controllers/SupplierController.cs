...
using SV22T1020218.Models.Partner;
    ...
    public class SupplierController : Controller
    {
        ...
        public async Task<IActionResult> SaveData(Supplier data)
        {
            try
            {
                ...
                {
                    // LƯU Ý: Phải gọi đúng hàm ValidateSupplierEmailAsync (Kiểm tra bên bảng Suppliers)
                    // Nếu chưa có hàm này trong PartnerDataService, ông cháu nhớ tạo thêm nhé!
